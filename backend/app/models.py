...
class SubmissionTask(Base, TimestampMixin):
    ...
    operator_id: Mapped[Optional[str]] = mapped_column(String(120), index=True)
    verification_level: Mapped[str] = mapped_column(String(40), default="NONE", index=True)
    verification_status: Mapped[str] = mapped_column(String(60), default="NONE", index=True)
    error_code: Mapped[Optional[str]] = mapped_column(String(80), index=True)
    error_message: Mapped[Optional[str]] = mapped_column(Text)
    retry_blocked_reason: Mapped[Optional[str]] = mapped_column(Text)
